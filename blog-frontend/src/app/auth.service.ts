...
// Add these inside your AuthService class
...
// PUT: Updates the text content of an existing post
updatePost(postId: number, postData: any): Observable<any> {
  return this.http.put(`http://localhost:8080/api/posts/${postId}`, postData);
}
